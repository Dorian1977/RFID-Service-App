...
namespace BlowFishClassLibrary {
	...
	private:
		//DWORD* PArray;
		//DWORD(*SBoxes)[256];
        void 		Blowfish_encipher(DWORD* xl, DWORD* xr, DWORD* PArray, DWORD(*SBoxes)[256]);
		void 		Blowfish_decipher(DWORD* xl, DWORD* xr, DWORD* PArray, DWORD(*SBoxes)[256]);
        DWORD		GetOutputLength(DWORD lInputLong);

	public:
		//BlowFish();
		//~BlowFish();
        void 	    Initialize(BYTE key[], int keybytes, DWORD* PArray, DWORD(*SBoxes)[256]);
